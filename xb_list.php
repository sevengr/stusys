	...
	$(document).ready(function(){
		...
		$(".btn").click(function(){
			...
			if (mid == ""){
				...
				$.post("xb_delete_check.php",{mid:mid},function(data){
					if($.trim(data)=='yes'){
						alert('成功删除！');
						location.reload();
					}else{
...
<body>
	<div class="row">
		<div class="col-xs-3" style="background-color:#E3F2FD">
			<div align="center">
				<font face="楷体" size=4 color="red">此处输入系部编码。</font>
			</div>
				
			<div width="30%" align="center">
				<form  align=left>
					<input type="text" id="mid" class="form-control" placeholder="输入要删除的系部编码">
	...
	<div class="panel panel-info">
	  ...
	  <div class="panel-heading">系部列表</div>
