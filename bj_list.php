	...
	$(document).ready(function(){
		...
		$(".btn").click(function(){
			...
			if (mid == ""){
				...
				$.post("bj_delete_check.php",{mid:mid},function(data){
					if($.trim(data)=='yes'){
						alert('成功删除！');
						location.reload();
					}else{
...
<body>
	<div class="row">
		<div class="col-xs-3" style="background-color:#E3F2FD">
			<div align="center">
				<font face="楷体" size=4 color="red">此处输入班级编码。</font>
			</div>
				
			<div width="30%" align="center">
				<form  align=left>
					<input type="text" id="mid" class="form-control" placeholder="输入要删除的班级编码">
